...
package frc.robot.subystems.LED;
...
public class LEDSubsystem extends SubsystemBase {
    ...
    public LEDSubsystem(
                        ...
                        ShooterSubsystem shootSub, AmpSubsystem ampSub, FeederSubsystem feederSub, Limelight limelight) {
    ...
    private void LEDStateMachine(LEDState newState) {
        ...
        case INTAKING:
            m_Matrix.setOff();
            m_ChassisRight.setAnimation(a_WhiteLeftStrobe);
        ...
        case FEEDING_AMP:
            ...
            m_ChassisLeft.setColor(pink);
            m_ChassisRight.setColor(pink);
            m_HorizontalStrip.setColor(pink);
            break;
        ...
        case FEEDING_SHOOTER:
            ...
            m_ChassisLeft.setColor(cyan);
            m_ChassisRight.setColor(cyan);
            m_HorizontalStrip.setColor(cyan);
            break;
        ...
        case HAVENOTE_SCORING:
            m_Matrix.setOff();
            m_ChassisLeft.setColor(green);
            m_ChassisRight.setColor(green);
            m_HorizontalStrip.setColor(green);
        ...
        case SHOOTING_SEQUENCE:
            m_Matrix.setOff();
            m_ChassisRight.setAnimation(a_LeftCyanFlow);
            m_VerticalRight.setAnimation(a_RightCyanFlow);
        break;

        case READY_TO_SHOOT:
            m_Matrix.setOff();
            m_ChassisRight.setAnimation(a_GreenLeftStrobe);
            m_VerticalRight.setAnimation(a_GreenRightStrobe);
        break;

        case AMPING:
            m_Matrix.setOff();
            m_VerticalRight.setAnimation(a_LeftPurpleFlow);
            m_VerticalRight.setAnimation(a_RightPurpleFlow);
            m_ChassisLeft.setColor(purple);
            m_ChassisRight.setColor(purple);
            m_HorizontalStrip.setColor(purple);
        break;
    ...
    Animation a_BrownLeftStrobe = new StrobeAnimation(brown.r, brown.g, brown.b, 0, 0.2, m_VerticalLeft.segmentSize, m_VerticalLeft.startIndex); // Flash
    Animation a_BrownRightStrobe = new StrobeAnimation(brown.r, brown.g, brown.b, 0, 0.2, m_VerticalRight.segmentSize, m_VerticalRight.startIndex);
    Animation a_BrownChassisLeftStrobe =  new StrobeAnimation(brown.r, brown.g, brown.b, 0, 0.2, m_ChassisRight.segmentSize, m_ChassisRight.startIndex);
    Animation a_BrownChassisRightStrobe =  new StrobeAnimation(brown.r, brown.g, brown.b, 0, 0.2, m_ChassisLeft.segmentSize, m_ChassisLeft.startIndex);
     Animation a_BrownHorizontalStrobe =  new StrobeAnimation(brown.r, brown.g, brown.b, 0, 0.2, m_HorizontalStrip.segmentSize, m_HorizontalStrip.startIndex);
