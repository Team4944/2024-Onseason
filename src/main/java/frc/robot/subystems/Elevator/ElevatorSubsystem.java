package frc.robot.subystems.Elevator;
...
public class ElevatorSubsystem extends SubsystemBase {
  ...
  private TalonFX elevatorFollowerTalon = configureElevatorTalon(
      TalonFXFactory.createTalon(ElevatorConstants.elevatorFollowerTalonID,
          ...
          private TimeOfFlight amplineupSensor = new TimeOfFlight(AmpConstants.ampSensorID);

  public ElevatorSubsystem() {
    amplineupSensor.setRangingMode(AmpConstants.ampSensorRange, AmpConstants.ampSampleTime);
    amplineupSensor.setRangeOfInterest(8, 8, 12, 12);
...
public boolean isNotePresentTOF() {
  return amplineupSensor.getRange() != 0.0 && amplineupSensor.getRange() < AmpConstants.isNotePresentTOF;
}

public double getRangeTOF() {
  return amplineupSensor.getRange();
}
