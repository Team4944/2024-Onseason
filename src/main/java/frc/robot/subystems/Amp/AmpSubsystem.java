package frc.robot.subystems.Amp;
...
public class AmpSubsystem extends SubsystemBase {
  ...
  public boolean isNotePresentTOF() {
    return ampSensor.getRange() != 0.0 && ampSensor.getRange() < AmpConstants.isNotePresentTOF;
  }
  ...
  public void periodic() {
    ...
    SmartDashboard.putNumber("range amp", getRangeTOF());
