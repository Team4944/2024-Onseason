...
package frc.robot.subystems.Feeder;
...
public class FeederSubsystem extends SubsystemBase {
  ...
  public boolean isNotePresentTOF() {
    return feederSensor.getRange() != 0.0 && feederSensor.getRange() < FeederConstants.isNotePresentTOF;
  }
  ...
  public void periodic() {
     SmartDashboard.putNumber("range feeder", getRangeTOF());
  }
